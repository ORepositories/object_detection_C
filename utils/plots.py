...
def plot_one_box(midpoint,center_point, x, img, color=None, label=None, line_thickness=3):
    ...
    if label:
        ...
        x_mean=int(midpoint[0])
        y_mean=int(midpoint[1])
        if center_point:
            cv2.circle(img, (x_mean,y_mean), radius=0, color=(255, 0, 0), thickness=10)
